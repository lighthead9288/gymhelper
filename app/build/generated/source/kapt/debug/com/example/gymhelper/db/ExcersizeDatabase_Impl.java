...
public final class ExcersizeDatabase_Impl extends ExcersizeDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(11) {
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsExcersizes.put("ExcersizeId", new TableInfo.Column("ExcersizeId", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsExcersizes.put("Name", new TableInfo.Column("Name", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsExcersizes.put("Group", new TableInfo.Column("Group", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsExcersizes.put("Subgroup", new TableInfo.Column("Subgroup", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsExcersizes.put("Description", new TableInfo.Column("Description", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsExcersizes.put("Level", new TableInfo.Column("Level", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoExcersizes.equals(_existingExcersizes)) {
          return new RoomOpenHelper.ValidationResult(false, "Excersizes(com.example.gymhelper.db.Excersize).\n"
                  + " Expected:\n" + _infoExcersizes + "\n"
                  + " Found:\n" + _existingExcersizes);
        }
        ...
        if (! _infoPhotos.equals(_existingPhotos)) {
          return new RoomOpenHelper.ValidationResult(false, "Photos(com.example.gymhelper.db.Photo).\n"
                  + " Expected:\n" + _infoPhotos + "\n"
                  + " Found:\n" + _existingPhotos);
        }
        final HashMap<String, TableInfo.Column> _columnsExcersizePhoto = new HashMap<String, TableInfo.Column>(3);
        _columnsExcersizePhoto.put("Id", new TableInfo.Column("Id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsExcersizePhoto.put("ExcersizeId", new TableInfo.Column("ExcersizeId", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsExcersizePhoto.put("PhotoId", new TableInfo.Column("PhotoId", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoExcersizePhoto.equals(_existingExcersizePhoto)) {
          return new RoomOpenHelper.ValidationResult(false, "ExcersizePhoto(com.example.gymhelper.db.ExcersizePhoto).\n"
                  + " Expected:\n" + _infoExcersizePhoto + "\n"
        ...
        _columnsTrainingPrograms.put("TrainingProgramId", new TableInfo.Column("TrainingProgramId", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTrainingPrograms.put("Name", new TableInfo.Column("Name", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoTrainingPrograms.equals(_existingTrainingPrograms)) {
          return new RoomOpenHelper.ValidationResult(false, "TrainingPrograms(com.example.gymhelper.db.TrainingProgram).\n"
        ...
        _columnsTrainingProgramsExcercizes.put("Id", new TableInfo.Column("Id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTrainingProgramsExcercizes.put("ExcersizeId", new TableInfo.Column("ExcersizeId", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTrainingProgramsExcercizes.put("DayId", new TableInfo.Column("DayId", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoTrainingProgramsExcercizes.equals(_existingTrainingProgramsExcercizes)) {
          return new RoomOpenHelper.ValidationResult(false, "TrainingProgramsExcercizes(com.example.gymhelper.db.TrainingProgramsExcersizes).\n"
        ...
        _columnsTrainingProgramDays.put("TrainingProgramDayId", new TableInfo.Column("TrainingProgramDayId", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTrainingProgramDays.put("trainingProgramId", new TableInfo.Column("trainingProgramId", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTrainingProgramDays.put("dayName", new TableInfo.Column("dayName", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoTrainingProgramDays.equals(_existingTrainingProgramDays)) {
          return new RoomOpenHelper.ValidationResult(false, "TrainingProgramDays(com.example.gymhelper.db.TrainingProgramDay).\n"
        ...
        _columnsTrainingProfiles.put("TrainingProfileId", new TableInfo.Column("TrainingProfileId", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTrainingProfiles.put("Name", new TableInfo.Column("Name", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoTrainingProfiles.equals(_existingTrainingProfiles)) {
          return new RoomOpenHelper.ValidationResult(false, "TrainingProfiles(com.example.gymhelper.db.TrainingProfile).\n"
        ...
        _columnsTrainingProfilesExcersizes.put("Id", new TableInfo.Column("Id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTrainingProfilesExcersizes.put("TrainingProfileId", new TableInfo.Column("TrainingProfileId", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTrainingProfilesExcersizes.put("ExcersizeId", new TableInfo.Column("ExcersizeId", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoTrainingProfilesExcersizes.equals(_existingTrainingProfilesExcersizes)) {
          return new RoomOpenHelper.ValidationResult(false, "TrainingProfilesExcersizes(com.example.gymhelper.db.TrainingProfileExcersize).\n"
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "Excersizes","Photos","ExcersizePhoto","TrainingPrograms","TrainingProgramsExcercizes","TrainingProgramDays","TrainingProfiles","TrainingProfilesExcersizes");
  }
