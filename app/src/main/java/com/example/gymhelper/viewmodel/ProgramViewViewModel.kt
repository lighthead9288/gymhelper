...
class ProgramViewViewModel(private val db: ExcersizeDatabase, val application: Application): ViewModel() {
    ...
    private suspend fun getCurTrainingProgramFromDb(id: Long): ProgramByDays {
        return withContext(Dispatchers.IO) {
            ...
            val trainingProgramDays = db.trainingProgramDayDao.getTrainingProgramDays(id)
